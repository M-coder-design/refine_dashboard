import { Box,Typography,FormHelperText,TextField,TextareaAutosize,Stack,Select,FormControl,MenuItem,Button } from "@pankod/refine-mui"
    ...
    <Box>
      ...
      <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#fcfcfc">
        <form style={{
          ...
          <FormControl>
            <FormHelperText sx={{fontWeight: 500, margin: '10px 0', fontSize: 16,color: "#11142d"}}>Write Description</FormHelperText>
            <TextareaAutosize minRows={5} required placeholder="Write description" color="info"
             style={{
              width: '100%',background: 'transparent',fontSize: '16px',borderColor:'rgba(0,0,0,0.23)',
          ...
          <Stack direction="column" gap={1} justifyContent="center" mb={2}>
            <Stack direction="row" gap={2}>
              <Typography color="#1142d" fontSize={16} fontWeight={500} my="10px">Property Photo</Typography>
